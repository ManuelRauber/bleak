...
(function ($) {
    ...
    !function () {
        ...
        t.version = '0.7.0', t.utils = {}, t.utils.warn = function (t) {
            ...
            return e;
        }, t.tokenizer.label = 'default', t.tokenizer.registeredFunctions = { 'default': t.tokenizer }, t.tokenizer.registerFunction = function (e, n) {
            ...
            var i = {}, r = new t.SortedSet, o = e[this._ref], n = void 0 === n ? !0 : n;
            ...
            for (var s = 0; s < r.length; s++) {
                for (var a = r.elements[s], h = 0, u = 0; u < this._fields.length; u++) {
                    var l = this._fields[u], c = i[l.name], f = c.length;
                    if (f) {
            ...
            var n = this.pipeline.run(this.tokenizerFn(e)), i = new t.Vector, r = [], o = this._fields.reduce(function (t, e) {
                return t + e.boost;
            ...
            n.forEach(function (e, n, s) {
                var a = 1 / s.length * this._fields.length * o, h = this, u = this.tokenStore.expand(e).reduce(function (n, r) {
                    var o = h.corpusTokens.indexOf(r), s = h.idf(r), u = 1, l = new t.SortedSet;
                    if (r !== e) {
            ...
            for (var n = this.documentStore.get(e), i = n.length, r = new t.Vector, o = 0; i > o; o++) {
                var s = n.elements[o], a = this.tokenStore.get(s)[e].tf, h = this.idf(s);
            ...
            var t = {
                    ...
                    biliti: 'ble',
                    logi: 'log'
                }, e = { icate: 'ic', ative: '', alize: 'al', iciti: 'ic', ical: 'ic', ful: '', ness: '' }, n = '[^aeiou]', i = '[aeiouy]',
                r = n + '[^aeiouy]*', o = i + '[aeiou]*', s = '^(' + r + ')?' + o + r, a = '^(' + r + ')?' + o + r + '(' + o + ')?$',
                h = '^(' + r + ')?' + o + r + o + r, u = '^(' + r + ')?' + i, l = new RegExp(s), c = new RegExp(h), f = new RegExp(a),
                d = new RegExp(u), p = /^(.+?)(ss|i)es$/, v = /^(.+?)([^s])s$/, g = /^(.+?)eed$/, m = /^(.+?)(ed|ing)$/, y = /.$/,
                S = /(at|bl|iz)$/, w = new RegExp('([^aeiouylsz])\\1$'), k = new RegExp('^' + r + i + '[^aeiouwxy]$'),
                x = /^(.+?[^aeiou])y$/,
                ...
                F = /^(.+?)(al|ance|ence|er|ic|able|ible|ant|ement|ment|ent|ou|ism|ate|iti|ous|ive|ize)$/, _ = /^(.+?)(s|t)(ion)$/,
                z = /^(.+?)e$/, O = /ll$/, P = new RegExp('^' + r + i + '[^aeiouwxy]$'), T = function (n) {
                    var i, r, o, s, a, h, u;
            ...
            var n = n || this.root, i = t.charAt(0), r = t.slice(1);
            return i in n || (n[i] = { docs: {} }), 0 === r.length ? (n[i].docs[e.ref] = e, void(this.length += 1)) : this.add(r, e, n[i]);
